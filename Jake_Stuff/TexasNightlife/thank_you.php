...
<body>
    ...
    <!-- /.navbar -->
    <!-- begin outer shell -->
    <div class="col-sm-12 outer_shell thank_you">
        <h1>Thank you for your submission! <br>We will get back to you ASAP regarding your request.</h1>
    </div>
    <!-- Footer -->
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <ul class="list-inline" id="footer">
                        ...
                        <li class="footer-menu-divider">&sdot;</li>
                        <li>
                           <a href="https://www.snapchat.com/texasnightlife/" <i class="fa fa-snapchat fa-4x icon" aria-hidden="true"></i>
                            </a>
                            <p>SNAPCHAT</p>
                        </li>
                    </ul>
